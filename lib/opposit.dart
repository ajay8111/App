...
class Opposit extends StatefulWidget {
  @override
  _OppositState createState() => _OppositState();
}

class _OppositState extends State<Opposit> with SingleTickerProviderStateMixin {
